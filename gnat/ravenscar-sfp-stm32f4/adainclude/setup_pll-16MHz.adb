...
procedure Setup_Pll is
   ...
   --  16 MHz HSE clock. The PLL values are used when Activate_PLL is True.

   HSECLK          : constant HSECLK_Range := 16_000_000; -- ext. clock is 16 MHz
   ...
   PLLM_Value  : constant := 16;     -- divider in range 2 .. 63
